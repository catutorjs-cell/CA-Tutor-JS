      ...
      <div class="dashboard-grid" style="grid-template-columns: repeat(3, 1fr);">
        ...
        <div class="dashboard-flip-card" id="dashboard-rev-flip-card">
          <div class="flip-card-inner">
            ...
            ` : `
               <div class="flip-card-back glass-card stat-card" style="margin: 0; display: flex !important; flex-direction: column !important; background: ...; justify-content: center; align-items: center; text-align: center; padding: 15px;">
